...
const chipStyleMap = {
  ...
  purple: { bg: "#ede9fe", color: appTheme.colors.primary },
};
...
const MyFormsPage: React.FC = () => {
  ...
  return (
    <Box maxWidth="lg" mx="auto" px={2} py={4} sx={{ backgroundColor: appTheme.colors.background }}>
      {forms.length > 0 ? (
        <Box
          display="flex"
          flexWrap="wrap"
              ...
              <Card
                ...
                sx={{
                  ...
                  "&:hover": {
                    ...
                    boxShadow: "0 8px 15px rgba(59,31,142,0.2)",
                  },
                }}
              >
                <CardContent sx={{ p: 3 }}>
                  <Box display="flex" justifyContent="space-between" mb={2}>
                    <Box flex={1}>
                      <Typography variant="h6" sx={{ fontWeight: 600, fontSize: "1.125rem", color: "#374151", mb: 1 }}>
                        {form.title}
                      </Typography>
                  ...
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 0.5, fontSize: "0.75rem", color: "#9ca3af" }}>
        ...
        <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" py={10}>
          ...
          <Typography variant="h6" sx={{ color: appTheme.colors.textPrimary, mb: 1 }}>
            No forms saved yet
          </Typography>
          <Typography
            variant="body2"
          ...
          >
            You haven't created any forms yet. Start building your first form to see it appear here.
          </Typography>
          <Button
            variant="contained"
            startIcon={<Add />}
      ...
      <Dialog open={openDeleteDialog} onClose={() => setOpenDeleteDialog(false)}>
        <DialogTitle sx={{ fontWeight: 600, color: appTheme.colors.textPrimary }}>Delete Form</DialogTitle>
        <DialogContent>
          <DialogContentText sx={{ color: appTheme.colors.textSecondary, fontSize: appTheme.font.sizeMd }}>
